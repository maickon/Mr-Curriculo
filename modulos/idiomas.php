...
$selectOptions = array('Iniciante','Básico','Experiênte','Profissional','Expert');


$pagina_nome = 'Idiomas. Aqui você informa quais idiomas você tem fluência.';
...
switch ($tela):
	...
	case 'listar':
		...
		$tag->open('table','cellspacing="0" cellpadding="0" border="0" class="display" id="listausers" ');
			$tag->open('thead');
			 	$tag->open('tr');
                    $labels = array('Idioma','Nivel','Ações');
			 		ths($labels);
			 	$tag->close('tr');
